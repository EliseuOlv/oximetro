...
const char* password = "SENHA";  // Senha Rede.
...
void loop()
{
  ...
  if (millis() - tsLastReport > REPORTING_PERIOD_MS)
  {
   ...
   if (SpO2 == 95) {
      ...
      digitalWrite(13, LOW); //verde acende se SpO2=95
      digitalWrite(15, LOW);
      delay(100);
      ...
      if (SpO2 < 95) {
        digitalWrite(12, LOW); //azul acende se SpO2<95
        ...
        if (SpO2 > 95) {
          ...
          digitalWrite(12, LOW);
          digitalWrite(13, LOW);
          digitalWrite(15, HIGH); //vermelho acende se SpO2>95
          delay(100);
        }
      }
    }
